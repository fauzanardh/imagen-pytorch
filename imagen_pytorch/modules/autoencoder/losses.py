...
from imagen_pytorch.modules.autoencoder import NLayerDiscriminator, weights_init
...
class LPIPS(nn.Module):
    ...
    def __init__(self, path, use_dropout=True):
        super().__init__()
        ...
        self.load_from_pretrained(path)
    ...
    def load_from_pretrained(self, path):
        ...
        print("loaded pretrained LPIPS loss from {}".format(path))
...
class LPIPSWithDiscriminator(nn.Module):
    def __init__(
        ...
        self.perceptual_loss = LPIPS(path).eval()
    ...
    def forward(
        ...
        if optimizer_idx == 0:
            ...
            log = {
                ...
                "{}/disc_factor".format(split): torch.tensor(disc_factor).item(),
